sentence = '''My very photogenic mother died in a freak accident (picnic, lightning) when I was three, and, 
              save for a pocket of warmth in the darkest past, nothing of her subsists within the hollows 
...
print(*sorted(set([i.strip(':;,.?!()').lower() for i in sentence.split() if len(i.strip(':;,.?!()')) < 4])))
